    ...
    / { \
        macros { \
            name: name { \
                ...
                label = U_STRINGIFY(UC_MACRO_ ## name); \
                wait-ms = <0>; \
                tap-ms = <0>; \
                #binding-cells = <0>; \
    ...
    / { \
        behaviors { \
            name: name { \
                ...
                label = U_STRINGIFY(UC_MORPH_ ## name); \
                #binding-cells = <0>; \
...
#define ZMK_UNICODE_PAIR_3_3(name, L0, L1, L2, U0, U1, U2) \
    UC_MACRO(name ## _lower, &kp L0 &kp L1 &kp L2) \
    UC_MACRO(name ## _upper, &kp U0 &kp U1 &kp U2) \
    UC_MODMORPH(name, &name ## _lower, &name ## _upper)

#define ZMK_UNICODE_PAIR_3_4(name, L0, L1, L2, U0, U1, U2, U3) \
    UC_MACRO(name ## _lower, &kp L0 &kp L1 &kp L2) \
    UC_MACRO(name ## _upper, &kp U0 &kp U1 &kp U2 &kp U3) \
    UC_MODMORPH(name, &name ## _lower, &name ## _upper)

#define ZMK_UNICODE_PAIR_4_4(name, L0, L1, L2, L3, U0, U1, U2, U3) \
