...
#define MIRYOKU_SENSOR_BINDING_LAYER_BASE &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_MEDIA &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_NAV &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_EXTRA &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_SYM &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_NUM &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_FUN &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_TAP &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_BUTTON &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_MOUSE &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN
#define MIRYOKU_SENSOR_BINDING_LAYER_ACC &inc_dec_kp C_VOLUME_UP C_VOLUME_DOWN