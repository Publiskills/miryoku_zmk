...
U_NA,              &kp RALT,          &u_to_U_FUN,       &dt_molock,        U_NA,              &tt_btclearall,    &u_bt_sel_0,       &u_bt_sel_1,       &u_bt_sel_2,       &u_bt_sel_3,       \
...
U_NA,              U_NA,              &u_to_U_SYM,       &dt_molock,        U_NA,              U_NU,              U_NU,            U_NU,            U_NU,            &x_extra,        \
